...
export default {
            ...
            let sex = report_gender[j];
              if (gender.hasOwnProperty(sex) && !this.hasRow(age_group, sex)) {
                ...
                this.rows.push({
                  ...
                  age_group: age_group,
                  gender: sex,
                  defaulted_new_registration: numbers[0],
                  defaulted_old_registration: numbers[1],
                  died: numbers[2],
                  stopped: numbers[3],
  ...
  data: function () {
    return {
      ...
      showLoader: false,
      slots: [
        "defaulted_new_registration",
        "defaulted_old_registration",
        "died",
        "stopped",
        "transferred_out",
        "unknown",
      ...
      columns: [
        ...
        {
          label: "Defaulted (new registration)",
          name: "defaulted_new_registration",
          slot_name: "defaulted_new_registration",
          sort: true,
        },
        {
          label: "Defaulted (old registration)",
          name: "defaulted_old_registration",
          slot_name: "defaulted_old_registration",
          sort: true,
        },
        {
          label: "Died",
