<template>
  <div class="border-right side-bar" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <router-link :to="{name: 'ListUsers'}" class="side-list list-group-item list-group-item-action">Users</router-link>
        ...
        <a href="#" class="side-list list-group-item list-group-item-action ">Status</a> -->
      </div>
    </div>
</template>
