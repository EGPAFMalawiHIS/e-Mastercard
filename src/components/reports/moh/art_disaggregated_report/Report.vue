...
<template>
  <div class="content">
    <h4 style="font-weight:bold; float:left;">ART Disagreggated Report</h4>
...
export default {
  ...
  methods: {
    ...
    fetchTbScreened(ageGroup, url) {
      ...
      const PARAMS = `?gender=${this.GENDERS[this.GenderIndex]}&start_date=${START_DATE}&end_date=${END_DATE}&age_group=${ageGroup}&date=${DATE}&program_id=1&outcome_table=temp_patient_outcomes`;
      this.RebuildReport = false;
